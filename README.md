...
- **Sigma Clipping:** Advanced statistical outlier rejection with automatic and manual kernel configurations for effective cosmic ray removal.
...
A streamlined workflow to apply master calibration frames to your science images in batch.
...
- **Hot Pixel Interpolation:** Maps and cleanly interpolates hot pixels utilizing spatial median filters before the primary calibration steps.
- **Batch Processing:** Rapidly processes hundreds of light frames through standard Bias subtraction, Dark subtraction, and Flat-field division.

### 3. Multi Photometry
A powerful scientific module designed for extracting instrumental and apparent magnitudes across time-series datasets.
- **High-Accuracy Detection:** Intelligent star localization and aperture tracking across sequential frames.
...
- **Interactive Light Curves:** Generate, visualize, and export interactive, publication-quality light curves directly within the application.

### 4. Astrometry & Plate Solving
Seamlessly transform arbitrary image pixel coordinates into standard Right Ascension and Declination (WCS).
...
## Built With
*   **Python 3.10+**
*   **PyQt5** - For the robust and highly interactive Graphical User Interface.
